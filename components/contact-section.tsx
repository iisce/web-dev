			...
			<div className='max-w-4xl mx-auto'>
				<div className='text-center mb-12'>
					...
					<p className='text-lg text-muted-foreground max-w-2xl mx-auto text-pretty'>
						Secure your slot before December 31st. Limited spots
				...
				<div className='bg-card border border-border rounded-lg p-6 sm:p-8'>
					...
					>
						...
						<div className='grid grid-cols-1 sm:grid-cols-2 gap-6'>
							...
							<div className='space-y-2'>
								...
								>
									...
									<option value='1 Page Website - ₦100,000'>
										1 Page Website - ₦100,000
									</option>
									<option value='2-3 Page Website - ₦115,000'>
										2-3 Page Website - ₦115,000
									</option>
									<option value='5-6 Page Website - ₦125,000'>
										5-6 Page Website - ₦125,000
									</option>
								</select>
							</div>
						</div>
						...
						<p className='text-xs text-muted-foreground text-center'>
							By submitting this form, you'll be redirected to
